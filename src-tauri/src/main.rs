...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::settings::clear_ai_task_model,
            commands::settings::set_home_location,
            ...
            commands::image_review::keep_best_only,
            commands::image_review::keep_all_burst,
            commands::image_review::complete_image_review_and_start_video_review,
            ...
            commands::video_review::exclude_videos,
            commands::video_review::restore_videos,
            commands::video_review::exclude_media_item,
            commands::video_review::restore_media_item,
            commands::video_review::exclude_media_items,
            commands::video_review::complete_video_review_and_run_grouping,
