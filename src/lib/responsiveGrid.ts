...
export const CARD_LABEL_HEIGHT = 52;
export const CARD_BUTTON_HEIGHT = 44;
export const CARD_PADDING = 20;
export const CARD_GAP = 12;
export const ITEM_HEIGHT = THUMBNAIL_SIZE + CARD_LABEL_HEIGHT + CARD_BUTTON_HEIGHT + CARD_PADDING + CARD_GAP;
